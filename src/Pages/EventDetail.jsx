...
Guest: ${bookingResult.booking.guest_name}
Tickets: ${bookingResult.booking.quantity}
Amount: KES ${bookingResult.booking.total_amount}
`;
...
export default function EventDetail() {
  ...
  const [phone, setPhone] = useState(
    isLoggedIn ? savedUser.phone_number || "" : ""
  );

  const [guestName, setGuestName] = useState(
    isLoggedIn ? savedUser.name || "" : ""
  );

  const [guestEmail, setGuestEmail] = useState(
    isLoggedIn ? savedUser.email || "" : ""
  );
            ...
            {bookingResult ? (
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-sm text-gray-500">
                  {bookingResult.booking.guestName} —{" "}
                  {bookingResult.booking.quantity}
                  ticket(s)
                </p>
